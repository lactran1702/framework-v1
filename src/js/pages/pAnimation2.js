var pAnimation2 = {
    init: function(){
        ...
        function init() {
            ...
            setTimeout(function(){
                loadModel("uploads/testanimCP.fbx", "uploads/soccerplayer_CP.jpg", function(object){
                    object.position.x = 200;
                });
            }, 200);
            loadModel("uploads/testanimQH.fbx", "uploads/soccerplayer_QH.jpg", function(object){
                object.position.x = 400;
            });
            loadModel("uploads/testanimDC.fbx", "uploads/soccerplayer_DC.jpg", function(object){
                // đứng đầu
            });
